...
PLATFORMS = (Platform.ALARM_CONTROL_PANEL, Platform.BINARY_SENSOR, Platform.BUTTON, Platform.CLIMATE, Platform.COVER, Platform.DEVICE_TRACKER, Platform.FAN, Platform.LIGHT, Platform.LOCK, Platform.NUMBER, Platform.SELECT, Platform.SENSOR, Platform.SIREN, Platform.SWITCH)
...
DEBUG_LEVELS = {DEBUG_COMP_BELLOWS: logging.DEBUG, DEBUG_COMP_ZHA: logging.DEBUG, DEBUG_COMP_ZIGPY: logging.DEBUG, DEBUG_COMP_ZIGPY_ZNP: logging.DEBUG, DEBUG_COMP_ZIGPY_DECONZ: logging.DEBUG, DEBUG_COMP_ZIGPY_XBEE: logging.DEBUG, DEBUG_COMP_ZIGPY_ZIGATE: logging.DEBUG}
...
ZHA_CONFIG_SCHEMAS = {ZHA_OPTIONS: CONF_ZHA_OPTIONS_SCHEMA, ZHA_ALARM_OPTIONS: CONF_ZHA_ALARM_SCHEMA}
_ControllerClsType = type[zigpy.application.ControllerApplication]

class RadioType(enum.Enum):
    """Possible options for radio type."""
    ezsp = ('EZSP = Silicon Labs EmberZNet protocol: Elelabs, HUSBZB-1, Telegesis', bellows.zigbee.application.ControllerApplication)
    znp = ('ZNP = Texas Instruments Z-Stack ZNP protocol: CC253x, CC26x2, CC13x2', zigpy_znp.zigbee.application.ControllerApplication)
    deconz = ('deCONZ = dresden elektronik deCONZ protocol: ConBee I/II, RaspBee I/II', zigpy_deconz.zigbee.application.ControllerApplication)
    zigate = ('ZiGate = ZiGate Zigbee radios: PiZiGate, ZiGate USB-TTL, ZiGate WiFi', zigpy_zigate.zigbee.application.ControllerApplication)
    xbee = ('XBee = Digi XBee Zigbee radios: Digi XBee Series 2, 2C, 3', zigpy_xbee.zigbee.application.ControllerApplication)
...
REPORT_CONFIG_DEFAULT = (REPORT_CONFIG_MIN_INT, REPORT_CONFIG_MAX_INT, REPORT_CONFIG_RPT_CHANGE)
REPORT_CONFIG_ASAP = (REPORT_CONFIG_MIN_INT_ASAP, REPORT_CONFIG_MAX_INT, REPORT_CONFIG_RPT_CHANGE)
REPORT_CONFIG_BATTERY_SAVE = (REPORT_CONFIG_MIN_INT_BATTERY_SAVE, REPORT_CONFIG_MAX_INT_BATTERY_SAVE, REPORT_CONFIG_RPT_CHANGE)
REPORT_CONFIG_IMMEDIATE = (REPORT_CONFIG_MIN_INT_IMMEDIATE, REPORT_CONFIG_MAX_INT, REPORT_CONFIG_RPT_CHANGE)
REPORT_CONFIG_OP = (REPORT_CONFIG_MIN_INT_OP, REPORT_CONFIG_MAX_INT, REPORT_CONFIG_RPT_CHANGE)
...
WARNING_DEVICE_STROBE_LOW = 0
WARNING_DEVICE_STROBE_MEDIUM = 1
WARNING_DEVICE_STROBE_HIGH = 2
WARNING_DEVICE_STROBE_VERY_HIGH = 3
