...
from  import async_post_backup, async_pre_backup
from  import HomeAssistant

async def test_pre_backup(hass: HomeAssistant, zigpy_app_controller: ControllerApplication, setup_zha) -> None:
    ...
    zigpy_app_controller.backups.create_backup.assert_called_once_with(load_devices=True)
